...
(defconst doctest-mode-map 
  (let ((map (make-keymap)))
    ...
    ;; Three lines added by Brandon Craig Rhodes, May 2008:
    (define-key map "\C-?" 'doctest-electric-backspace)
    (define-key map "\r" 'doctest-newline-and-indent)
    (define-key map "\t" 'doctest-indent-source-line)
    ;;
