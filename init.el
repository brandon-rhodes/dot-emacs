...
;; Fix a bug in fzf.  This can be removed when a new version of fzf
;; comes out that sets the *fzf* buffer's directory every time instead
;; of relying on its earlier value.
